...
export default function ContactMe() {
  ...
  return (
    <div>
      <section
        id="contact"
        className="min-h-screen bg-[url('https://i.ibb.co/6v09WSC/v1016-a-02.jpg')] bg-no-repeat bg-cover bg-center"
      >
          ...
          <div className="lg:flex  lg:-mx-10 flex-row-reverse ">
            <div className="lg:w-1/2 lg:mx-10">
              ...
              <form ref={form} onSubmit={sendEmail} className="mt-12">
                ...
                <div className="w-1/2 text-center mt-7 cursor-pointer">
                  <ProjectButtonTwo>
                    <input
                      type="submit"
                      value="Send"
            ...
            <div className="mt-8 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10 justify-center gap-20">
