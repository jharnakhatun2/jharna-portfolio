...
const Hero = () => {
  ...
  return (
    <div
      id="hero"
      className="bg-[url('/src/assets/12.png')] bg-no-repeat bg-cover bg-center w-full h-ull lg:h-[550px] flex flex-col items-center justify-center py-10 lg:py-0"
    >
      <div className="px-2 container">
        <div className="flex items-center justify-center">
          <h1 className="text-xl md:text-3xl lg:text-5xl mr-2 text-gray-400">
            HEY, I'M
          </h1>
        ...
        <div className="w-full lg:w-7/12 mx-auto text-center">
          <h3 className="text-lg mb-7 lg:mb-10 text-gray-400">
          ...
          <div className="grid  grid-cols-1 md:grid-cols-2 gap-5 w-9/12 mx-auto">
            ...
            >
              <div className="btn btn-hover btn-primary shadow-lg w-full">
                <BsDownload />
